 ...
 * @front: A double pointer to the start point of args.
 * @exe_ret: The return value of the parent process' last executed command.
 *
 * Return: The return value of the final executed command.
 */
int call_args(char **args, char **front, int *exe_ret)
{
	int ret, index;
 ...
 * @exe_ret: The return value of the parent process' final executed command.
 *
