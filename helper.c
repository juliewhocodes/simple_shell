 ...
 *              information about the current process. The PID is that
 *              first word in the file. The function reads the PID into
 *              a buffer and replace the space at the end with a \0 byte.
 *
 * Return: The current process ID or NULL is on failure.
 */
char *get_pid(void)
{
	size_t i = 0;
 ...
 * @beginning: The environmental variable to look for.
